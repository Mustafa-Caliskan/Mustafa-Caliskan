...
* **[AutoRedTeam](https://github.com/Mustafa-Caliskan/AutoRedTeam)**  
  **Autonomous Agent Security Framework:** Automated red teaming tool built on Microsoft PyRIT and open-source LLMs to systematically evaluate enterprise agents against indirect prompt injection, excessive agency, and unauthorized tool execution.

* **[ai-soc-agent-lab](https://github.com/Mustafa-Caliskan/ai-soc-agent-lab)**  
  **CyberTech Neural Shield:** Multi-layered defense gateway for enterprise LLMs. Protects against covert Unicode steganography, PDF text smuggling, and prompt injection with DeBERTa-v3 semantic threat classification and outbound DLP data masking.

* **[Insect-Detection-System-YOLOv8-ViT-Gemini](https://github.com/Mustafa-Caliskan/Insect-Detection-System-YOLOv8-ViT-Gemini)**  
  **TUBITAK 2209-A Hybrid Vision Pipeline:** Two-stage pest detection and agricultural advisory platform combining YOLOv8m for localization, Vision Transformers (ViT) for fine-grained classification (0.95 mAP), and Gemini API for automated decision-support reporting.
...
* **Founding President** @ Digital Development Community (DGT) *(Feb. 2026 – Present)*
* **Campus Ambassador** @ Huawei Student Developers (HSD) *(Sep. 2025 – Aug. 2026)*
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Tenable-002D62?style=for-the-badge&logo=security&logoColor=white" />
</p>
...
* **LinkedIn:** [linkedin.com/in/mustafa-caliskann](https://www.linkedin.com/in/mustafa-caliskann/)
